...
/**
 * NOTE: This class is auto generated by Cloudinary.
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.cloudinary.com/v2/analysis/CLOUD_NAME/analyze';
     ...
     * @var string
     */
    protected $userAgent = 'CloudinaryAnalysisPHP/0.1.0 (PHP ' . PHP_VERSION . ')';
     ...
     *
     * @param string|null $cloudinaryUrl The CLOUDINARY_URL
     *
     * @return $this
     */
    public function setCloudinaryUrl(string $cloudinaryUrl = null): static
    {
     ...
     */
    protected function importCloudinaryUrl(): void
    {
     ...
     * Sets the cloud name.
     *
     * @param string $cloudName The account Id to set.
     *
     * @return $this
     */
     ...
     *
     * Cloud name comes after module name in the host (v2/module_name/cloud_name).
     *
     * The regex searches for the v{number}/module_name/{string} part of the host and replaces the last part with the cloud name.
     *
    ...
    {
        $this->host = preg_replace('/(\/v\d+\/[^\/]+\/)([^\/]+)(\/.*)/', '${1}' . $cloudName . '${3}', $this->host);
    ...
    {
        $report  = 'PHP SDK (Cloudinary\Analysis) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings(): array
    {
        return [
            [
                "url" => "https://api.cloudinary.com/v2/analysis/{cloud_name}/analyze",
                "description" => "No description provided",
                "variables" => [
                    "cloud_name" => [
                        "description" => "Your Cloud Name.",
                        "default_value" => "CLOUD_NAME",
                    ]
                ]
            ]
        ];
