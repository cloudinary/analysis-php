...
/**
 * AnalyzeCocoResponse Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeCocoResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeCocoResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'requestId' => 'string',
        'data' => '\Cloudinary\Analysis\Model\AnalyzeCocoResponseAllOfData'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Cloudinary\Analysis\Model\AnalyzeCocoResponseAllOfData|null
     */
    public function getData(): ?\Cloudinary\Analysis\Model\AnalyzeCocoResponseAllOfData
    {
     ...
     * Sets data
     *
     * @param \Cloudinary\Analysis\Model\AnalyzeCocoResponseAllOfData|null $data data
     *
     * @return $this
     */
    public function setData(?\Cloudinary\Analysis\Model\AnalyzeCocoResponseAllOfData $data): static
    {
        if (is_null($data)) {
