...
/**
 * VQAModerationParameters Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VQAModerationParameters implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VQAModerationParameters';
    ...
    */
    ...
    public function setRejectionQuestions(?array $rejectionQuestions): static
    {
        ...
        if ((count($rejectionQuestions) > 10)) {
            throw new InvalidArgumentException('invalid value for $rejectionQuestions when calling VQAModerationParameters., number of items must be less than or equal to 10.');
        }
        if ((count($rejectionQuestions) < 1)) {
            throw new InvalidArgumentException('invalid length for $rejectionQuestions when calling VQAModerationParameters., number of items must be greater than or equal to 1.');
        }
