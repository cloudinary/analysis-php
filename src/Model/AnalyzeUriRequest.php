...
/**
 * AnalyzeUriRequest Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeUriRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeUriRequest';
    ...
    protected static array $openAPITypes = [
        'uri' => 'string',
        'analysisType' => 'string',
        'parameters' => '\Cloudinary\Analysis\Model\AnalyzeUriRequestParameters'
    ];
    ...
    public const ANALYSIS_TYPE_CAPTIONING = 'captioning';
    public const ANALYSIS_TYPE_CLD_FASHION = 'cld_fashion';
    public const ANALYSIS_TYPE_CLD_TEXT = 'cld_text';
    public const ANALYSIS_TYPE_COCO = 'coco';
    public const ANALYSIS_TYPE_GOOGLE_TAGGING = 'google_tagging';
    public const ANALYSIS_TYPE_HUMAN_ANATOMY = 'human_anatomy';
    public const ANALYSIS_TYPE_LVIS = 'lvis';
    public const ANALYSIS_TYPE_SHOP_CLASSIFIER = 'shop_classifier';
    public const ANALYSIS_TYPE_UNIDET = 'unidet';
    public const ANALYSIS_TYPE_VQA_TAGGING = 'vqa_tagging';
    public const ANALYSIS_TYPE_VQA_MODERATION = 'vqa_moderation';
    public const ANALYSIS_TYPE_VQA_GENERAL = 'vqa_general';
    public const ANALYSIS_TYPE_CUSTOM = 'custom';
    ...
    {
        return [
            self::ANALYSIS_TYPE_CAPTIONING,
            self::ANALYSIS_TYPE_CLD_FASHION,
            self::ANALYSIS_TYPE_CLD_TEXT,
            self::ANALYSIS_TYPE_COCO,
            self::ANALYSIS_TYPE_GOOGLE_TAGGING,
            self::ANALYSIS_TYPE_HUMAN_ANATOMY,
            self::ANALYSIS_TYPE_LVIS,
            self::ANALYSIS_TYPE_SHOP_CLASSIFIER,
            self::ANALYSIS_TYPE_UNIDET,
            self::ANALYSIS_TYPE_VQA_TAGGING,
            self::ANALYSIS_TYPE_VQA_MODERATION,
            self::ANALYSIS_TYPE_VQA_GENERAL,
            self::ANALYSIS_TYPE_CUSTOM,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['analysisType'] === null) {
            $invalidProperties[] = "'analysisType' can't be null";
        }
        ...
        if (!is_null($this->container['analysisType']) && !in_array($this->container['analysisType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'analysisType', must be one of '%s'",
                $this->container['analysisType'],
    ...
    public function setAnalysisType(string $analysisType): static
    {
        ...
        $allowedValues = $this->getAnalysisTypeAllowableValues();
        if (!in_array($analysisType, $allowedValues, true)) {
     ...
     * Gets parameters
     *
     * @return \Cloudinary\Analysis\Model\AnalyzeUriRequestParameters|null
     */
    public function getParameters(): ?\Cloudinary\Analysis\Model\AnalyzeUriRequestParameters
    {
     ...
     * Sets parameters
     *
     * @param \Cloudinary\Analysis\Model\AnalyzeUriRequestParameters|null $parameters parameters
     *
     * @return $this
     */
    public function setParameters(?\Cloudinary\Analysis\Model\AnalyzeUriRequestParameters $parameters): static
    {
