...
/**
 * AnalyzeAIVisionTaggingRequest Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeAIVisionTaggingRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeAIVisionTaggingRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'tagDefinitions' => '\Cloudinary\Analysis\Model\AnalyzeAIVisionTaggingRequestAllOfTagDefinitions[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tagDefinitions', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['tagDefinitions'] === null) {
            $invalidProperties[] = "'tagDefinitions' can't be null";
        }
        if ((count($this->container['tagDefinitions']) > 10)) {
            $invalidProperties[] = "invalid value for 'tagDefinitions', number of items must be less than or equal to 10.";
        }

        if ((count($this->container['tagDefinitions']) < 1)) {
            $invalidProperties[] = "invalid value for 'tagDefinitions', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets tagDefinitions
     *
     * @return \Cloudinary\Analysis\Model\AnalyzeAIVisionTaggingRequestAllOfTagDefinitions[]
     */
    public function getTagDefinitions(): array
    {
        return $this->container['tagDefinitions'];
    }

    /**
     * Sets tagDefinitions
     *
     * @param \Cloudinary\Analysis\Model\AnalyzeAIVisionTaggingRequestAllOfTagDefinitions[] $tagDefinitions tagDefinitions
     *
     * @return $this
     */
    public function setTagDefinitions(array $tagDefinitions): static
    {
        if (is_null($tagDefinitions)) {
            throw new InvalidArgumentException('non-nullable tagDefinitions cannot be null');
        }

        if ((count($tagDefinitions) > 10)) {
            throw new InvalidArgumentException('invalid value for $tagDefinitions when calling AnalyzeAIVisionTaggingRequest., number of items must be less than or equal to 10.');
        }
        if ((count($tagDefinitions) < 1)) {
            throw new InvalidArgumentException('invalid length for $tagDefinitions when calling AnalyzeAIVisionTaggingRequest., number of items must be greater than or equal to 1.');
        }
        $this->container['tagDefinitions'] = $tagDefinitions;
