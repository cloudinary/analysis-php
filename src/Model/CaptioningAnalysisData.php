...
/**
 * CaptioningAnalysisData Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CaptioningAnalysisData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CaptioningAnalysisData';
    ...
    protected static array $openAPITypes = [
        'data' => '\Cloudinary\Analysis\Model\CaptioningAnalysisDataData',
        'modelVersion' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Cloudinary\Analysis\Model\CaptioningAnalysisDataData
     */
    public function getData(): \Cloudinary\Analysis\Model\CaptioningAnalysisDataData
    {
     ...
     * Sets data
     *
     * @param \Cloudinary\Analysis\Model\CaptioningAnalysisDataData $data data
     *
     * @return $this
     */
    public function setData(\Cloudinary\Analysis\Model\CaptioningAnalysisDataData $data): static
    {
        if (is_null($data)) {
     ...
     * Sets modelVersion
     *
     * @param int|null $modelVersion modelVersion
     *
     * @return $this
     */
