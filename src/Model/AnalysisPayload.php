...
/**
 * AnalysisPayload Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalysisPayload implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalysisPayload';
    ...
    */
     ...
     * @return object
     */
    public function getAnalysis(): object
    {
     ...
     * @return $this
     */
    public function setAnalysis(object $analysis): static
    {
        if (is_null($analysis)) {
