...
/**
 * VQAGeneralParameters Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VQAGeneralParameters implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VQAGeneralParameters';
    ...
    */
    ...
    public function setPrompts(?array $prompts): static
    {
        ...
        if ((count($prompts) > 10)) {
            throw new InvalidArgumentException('invalid value for $prompts when calling VQAGeneralParameters., number of items must be less than or equal to 10.');
        }
        if ((count($prompts) < 1)) {
            throw new InvalidArgumentException('invalid length for $prompts when calling VQAGeneralParameters., number of items must be greater than or equal to 1.');
        }
