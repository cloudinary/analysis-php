...
/**
 * AnalyzeCustomRequest Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeCustomRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeCustomRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('modelName', $data ?? [], null);
        $this->setIfExists('modelVersion', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['modelVersion'] === null) {
            $invalidProperties[] = "'modelVersion' can't be null";
        }
    ...
    public function setModelName(string $modelName): static
    {
        if (is_null($modelName)) {
            throw new InvalidArgumentException('non-nullable modelName cannot be null');
        }
     ...
     * Sets modelVersion
     *
     * @param int $modelVersion modelVersion
     *
     * @return $this
     */
    public function setModelVersion(int $modelVersion): static
    {
        if (is_null($modelVersion)) {
            throw new InvalidArgumentException('non-nullable modelVersion cannot be null');
        }
