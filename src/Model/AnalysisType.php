...
enum AnalysisType: string
{
    ...
    case CLD_FASHION = 'cld_fashion';

    case CLD_TEXT = 'cld_text';

    case COCO = 'coco';

    case GOOGLE_TAGGING = 'google_tagging';

    case HUMAN_ANATOMY = 'human_anatomy';

    case LVIS = 'lvis';

    case SHOP_CLASSIFIER = 'shop_classifier';

    case UNIDET = 'unidet';

    case AI_VISION_TAGGING = 'ai_vision_tagging';

    case AI_VISION_MODERATION = 'ai_vision_moderation';

    case AI_VISION_GENERAL = 'ai_vision_general';
