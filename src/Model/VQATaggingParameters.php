...
/**
 * VQATaggingParameters Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class VQATaggingParameters implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VQATaggingParameters';
    ...
    protected static array $openAPITypes = [
        'tagDefinitions' => '\Cloudinary\Analysis\Model\TagDefinition[]',
        'multiLabel' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('multiLabel', $data ?? [], false);
    }
    ...
    */
     ...
     * Gets tagDefinitions
     *
     * @return \Cloudinary\Analysis\Model\TagDefinition[]
     */
     ...
     * Sets tagDefinitions
     *
     * @param \Cloudinary\Analysis\Model\TagDefinition[] $tagDefinitions tagDefinitions
     *
     * @return $this
     */
    public function setTagDefinitions(array $tagDefinitions): static
    {
        ...
        if ((count($tagDefinitions) > 10)) {
            throw new InvalidArgumentException('invalid value for $tagDefinitions when calling VQATaggingParameters., number of items must be less than or equal to 10.');
        }
        if ((count($tagDefinitions) < 1)) {
            throw new InvalidArgumentException('invalid length for $tagDefinitions when calling VQATaggingParameters., number of items must be greater than or equal to 1.');
        }
    ...
    {
        return $this->container['multiLabel'];
    }

    /**
     * Sets multiLabel
     *
     * @param bool|null $multiLabel Return more than one label if applicable
     *
     * @return $this
     */
    public function setMultiLabel(?bool $multiLabel): static
    {
        if (is_null($multiLabel)) {
            throw new InvalidArgumentException('non-nullable multiLabel cannot be null');
        }
        $this->container['multiLabel'] = $multiLabel;
