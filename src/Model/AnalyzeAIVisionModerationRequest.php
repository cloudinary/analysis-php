...
/**
 * AnalyzeAIVisionModerationRequest Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeAIVisionModerationRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeAIVisionModerationRequest';
    ...
    protected static array $openAPITypes = [
        'source' => '\Cloudinary\Analysis\Model\Source',
    ...
    protected static array $setters = [
        'source' => 'setSource',
        'rejectionQuestions' => 'setRejectionQuestions'
    ];
    ...
    protected static array $getters = [
        'source' => 'getSource',
        'rejectionQuestions' => 'getRejectionQuestions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('rejectionQuestions', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['rejectionQuestions']) && (count($this->container['rejectionQuestions']) > 10)) {
            $invalidProperties[] = "invalid value for 'rejectionQuestions', number of items must be less than or equal to 10.";
        }

        if (!is_null($this->container['rejectionQuestions']) && (count($this->container['rejectionQuestions']) < 1)) {
            $invalidProperties[] = "invalid value for 'rejectionQuestions', number of items must be greater than or equal to 1.";
        }
     ...
     * Gets source
     *
     * @return \Cloudinary\Analysis\Model\Source
     */
    public function getSource(): ?\Cloudinary\Analysis\Model\Source
    {
     ...
     * Sets source
     *
     * @param \Cloudinary\Analysis\Model\Source $source source
     *
     * @return $this
     */
    public function setSource(?\Cloudinary\Analysis\Model\Source $source): static
    {
        if (is_null($source)) {
    ...
    /**
     * Gets rejectionQuestions
     *
     * @return string[]|null
     */
    public function getRejectionQuestions(): ?array
    {
        return $this->container['rejectionQuestions'];
    }

    /**
     * Sets rejectionQuestions
     *
     * @param string[]|null $rejectionQuestions A list of yes/no questions
     *
     * @return $this
     */
    public function setRejectionQuestions(?array $rejectionQuestions): static
    {
        if (is_null($rejectionQuestions)) {
            throw new InvalidArgumentException('non-nullable rejectionQuestions cannot be null');
        }

        if ((count($rejectionQuestions) > 10)) {
            throw new InvalidArgumentException('invalid value for $rejectionQuestions when calling AnalyzeAIVisionModerationRequest., number of items must be less than or equal to 10.');
        }
        if ((count($rejectionQuestions) < 1)) {
            throw new InvalidArgumentException('invalid length for $rejectionQuestions when calling AnalyzeAIVisionModerationRequest., number of items must be greater than or equal to 1.');
        }
        $this->container['rejectionQuestions'] = $rejectionQuestions;
