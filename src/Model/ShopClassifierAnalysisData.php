...
/**
 * ShopClassifierAnalysisData Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ShopClassifierAnalysisData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ShopClassifierAnalysisData';
    ...
    */
     ...
     * @return $this
     */
    public function setTags(object $tags): static
    {
        if (is_null($tags)) {
