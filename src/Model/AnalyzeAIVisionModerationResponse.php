...
/**
 * AnalyzeAIVisionModerationResponse Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeAIVisionModerationResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeAIVisionModerationResponse';
    ...
    protected static array $openAPITypes = [
        'limits' => '\Cloudinary\Analysis\Model\Limits',
        'requestId' => 'string',
        'data' => '\Cloudinary\Analysis\Model\AnalyzeAIVisionModerationResponseAllOfData'
    ];
    ...
    */
     ...
     * Gets limits
     *
     * @return \Cloudinary\Analysis\Model\Limits|null
     */
    public function getLimits(): ?\Cloudinary\Analysis\Model\Limits
    {
     ...
     * Sets limits
     *
     * @param \Cloudinary\Analysis\Model\Limits|null $limits limits
     *
     * @return $this
     */
    public function setLimits(?\Cloudinary\Analysis\Model\Limits $limits): static
    {
        if (is_null($limits)) {
     ...
     * Gets data
     *
     * @return \Cloudinary\Analysis\Model\AnalyzeAIVisionModerationResponseAllOfData|null
     */
    public function getData(): ?\Cloudinary\Analysis\Model\AnalyzeAIVisionModerationResponseAllOfData
    {
     ...
     * Sets data
     *
     * @param \Cloudinary\Analysis\Model\AnalyzeAIVisionModerationResponseAllOfData|null $data data
     *
     * @return $this
     */
    public function setData(?\Cloudinary\Analysis\Model\AnalyzeAIVisionModerationResponseAllOfData $data): static
    {
        if (is_null($data)) {
