...
/**
 * AnalyzeShopClassifierResponse Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeShopClassifierResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeShopClassifierResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'requestId' => 'string',
        'data' => '\Cloudinary\Analysis\Model\AnalyzeShopClassifierResponseAllOfData'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Cloudinary\Analysis\Model\AnalyzeShopClassifierResponseAllOfData|null
     */
    public function getData(): ?\Cloudinary\Analysis\Model\AnalyzeShopClassifierResponseAllOfData
    {
     ...
     * Sets data
     *
     * @param \Cloudinary\Analysis\Model\AnalyzeShopClassifierResponseAllOfData|null $data data
     *
     * @return $this
     */
    public function setData(?\Cloudinary\Analysis\Model\AnalyzeShopClassifierResponseAllOfData $data): static
    {
        if (is_null($data)) {
