...
/**
 * AnalyzeAIVisionModerationResponseAllOfData Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeAIVisionModerationResponseAllOfData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeAIVisionModerationResponse_allOf_data';
    ...
    protected static array $openAPITypes = [
        'entity' => 'string',
        'analysis' => '\Cloudinary\Analysis\Model\AIVisionModerationAnalysisData'
    ];
    ...
    */
     ...
     * Gets analysis
     *
     * @return \Cloudinary\Analysis\Model\AIVisionModerationAnalysisData|null
     */
    public function getAnalysis(): ?\Cloudinary\Analysis\Model\AIVisionModerationAnalysisData
    {
     ...
     * Sets analysis
     *
     * @param \Cloudinary\Analysis\Model\AIVisionModerationAnalysisData|null $analysis analysis
     *
     * @return $this
     */
    public function setAnalysis(?\Cloudinary\Analysis\Model\AIVisionModerationAnalysisData $analysis): static
    {
        if (is_null($analysis)) {
