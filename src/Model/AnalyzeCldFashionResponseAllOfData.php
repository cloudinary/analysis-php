...
/**
 * AnalyzeCldFashionResponseAllOfData Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeCldFashionResponseAllOfData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeCldFashionResponse_allOf_data';
    ...
    protected static array $openAPITypes = [
        'entity' => 'string',
        'analysis' => '\Cloudinary\Analysis\Model\CldFashionAnalysisData'
    ];
    ...
    */
     ...
     * Gets analysis
     *
     * @return \Cloudinary\Analysis\Model\CldFashionAnalysisData|null
     */
    public function getAnalysis(): ?\Cloudinary\Analysis\Model\CldFashionAnalysisData
    {
     ...
     * Sets analysis
     *
     * @param \Cloudinary\Analysis\Model\CldFashionAnalysisData|null $analysis analysis
     *
     * @return $this
     */
    public function setAnalysis(?\Cloudinary\Analysis\Model\CldFashionAnalysisData $analysis): static
    {
        if (is_null($analysis)) {
