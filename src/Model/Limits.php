...
class Limits implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Limits';
    ...
    protected static array $openAPITypes = [
        'usage' => '\Cloudinary\Analysis\Model\LimitsUsage'
    ];
    ...
    */
     ...
     * Gets usage
     *
     * @return \Cloudinary\Analysis\Model\LimitsUsage|null
     */
    public function getUsage(): ?\Cloudinary\Analysis\Model\LimitsUsage
    {
     ...
     * Sets usage
     *
     * @param \Cloudinary\Analysis\Model\LimitsUsage|null $usage usage
     *
     * @return $this
     */
    public function setUsage(?\Cloudinary\Analysis\Model\LimitsUsage $usage): static
    {
        if (is_null($usage)) {
