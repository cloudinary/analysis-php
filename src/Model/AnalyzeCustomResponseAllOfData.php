...
/**
 * AnalyzeCustomResponseAllOfData Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeCustomResponseAllOfData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeCustomResponse_allOf_data';
    ...
    protected static array $openAPITypes = [
        'entity' => 'string',
        'analysis' => '\Cloudinary\Analysis\Model\CustomAnalysisData'
    ];
    ...
    */
     ...
     * Gets analysis
     *
     * @return \Cloudinary\Analysis\Model\CustomAnalysisData|null
     */
    public function getAnalysis(): ?\Cloudinary\Analysis\Model\CustomAnalysisData
    {
     ...
     * Sets analysis
     *
     * @param \Cloudinary\Analysis\Model\CustomAnalysisData|null $analysis analysis
     *
     * @return $this
     */
    public function setAnalysis(?\Cloudinary\Analysis\Model\CustomAnalysisData $analysis): static
    {
        if (is_null($analysis)) {
