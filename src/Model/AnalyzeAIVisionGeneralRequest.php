...
/**
 * AnalyzeAIVisionGeneralRequest Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeAIVisionGeneralRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeAIVisionGeneralRequest';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['prompts']) && (count($this->container['prompts']) > 10)) {
            $invalidProperties[] = "invalid value for 'prompts', number of items must be less than or equal to 10.";
        }

        if (!is_null($this->container['prompts']) && (count($this->container['prompts']) < 1)) {
            $invalidProperties[] = "invalid value for 'prompts', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets prompts
     *
     * @param string[]|null $prompts One or more prompts of open questions or tasks with an open answer
     *
     * @return $this
     */
    public function setPrompts(?array $prompts): static
    {
        ...
        if ((count($prompts) > 10)) {
            throw new InvalidArgumentException('invalid value for $prompts when calling AnalyzeAIVisionGeneralRequest., number of items must be less than or equal to 10.');
        }
        if ((count($prompts) < 1)) {
            throw new InvalidArgumentException('invalid length for $prompts when calling AnalyzeAIVisionGeneralRequest., number of items must be greater than or equal to 1.');
        }
