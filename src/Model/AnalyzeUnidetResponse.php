...
/**
 * AnalyzeUnidetResponse Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeUnidetResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeUnidetResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'requestId' => 'string',
        'data' => '\Cloudinary\Analysis\Model\AnalyzeUnidetResponseAllOfData'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Cloudinary\Analysis\Model\AnalyzeUnidetResponseAllOfData|null
     */
    public function getData(): ?\Cloudinary\Analysis\Model\AnalyzeUnidetResponseAllOfData
    {
     ...
     * Sets data
     *
     * @param \Cloudinary\Analysis\Model\AnalyzeUnidetResponseAllOfData|null $data data
     *
     * @return $this
     */
    public function setData(?\Cloudinary\Analysis\Model\AnalyzeUnidetResponseAllOfData $data): static
    {
        if (is_null($data)) {
