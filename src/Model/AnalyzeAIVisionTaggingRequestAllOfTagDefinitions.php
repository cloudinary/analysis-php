...
/**
 * AnalyzeAIVisionTaggingRequestAllOfTagDefinitions Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeAIVisionTaggingRequestAllOfTagDefinitions implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeAIVisionTaggingRequest_allOf_tag_definitions';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The name of the tag to apply. This can be any string and does not affect the decision process
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string $description A description to be used by the AI to determine whether the tag should be applied
     *
     * @return $this
     */
