...
/**
 * AnalyzeUnidetResponseAllOfData Class Doc Comment
 *
 * @package  Cloudinary\Analysis
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AnalyzeUnidetResponseAllOfData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AnalyzeUnidetResponse_allOf_data';
    ...
    protected static array $openAPITypes = [
        'entity' => 'string',
        'analysis' => '\Cloudinary\Analysis\Model\UnidetAnalysisData'
    ];
    ...
    */
     ...
     * Gets analysis
     *
     * @return \Cloudinary\Analysis\Model\UnidetAnalysisData|null
     */
    public function getAnalysis(): ?\Cloudinary\Analysis\Model\UnidetAnalysisData
    {
     ...
     * Sets analysis
     *
     * @param \Cloudinary\Analysis\Model\UnidetAnalysisData|null $analysis analysis
     *
     * @return $this
     */
    public function setAnalysis(?\Cloudinary\Analysis\Model\UnidetAnalysisData $analysis): static
    {
        if (is_null($analysis)) {
