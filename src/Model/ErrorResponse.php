...
class ErrorResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'error' => '\Cloudinary\Analysis\Model\ErrorResponseError'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \Cloudinary\Analysis\Model\ErrorResponseError|null
     */
    public function getError(): ?\Cloudinary\Analysis\Model\ErrorResponseError
    {
     ...
     * Sets error
     *
     * @param \Cloudinary\Analysis\Model\ErrorResponseError|null $error error
     *
     * @return $this
     */
    public function setError(?\Cloudinary\Analysis\Model\ErrorResponseError $error): static
    {
        if (is_null($error)) {
